...
import 'package:cost_share/presentation/common/app_drop_down_button.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    super.initState();
    // Set the initial month and year to the current date values
